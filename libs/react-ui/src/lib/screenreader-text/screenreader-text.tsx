...
const ScreenreaderTextComponent: FC<
  PropsWithChildren<ScreenreaderTextProps>
> = ({ label }) => {
  return (
    <button>
      <span className="cvi-screenreader-text">{label}</span>
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
...
export default ScreenreaderTextComponent;
