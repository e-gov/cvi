      ...
      <div class="cvi-html-section__content">
        ...
        <div class="cvi-html-section__content-elements">
          <div class="cvi-labeled-icon">
            <svg  class="cvi-labeled-icon__wrapper--icon-before" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="cvi-labeled-icon__content">
