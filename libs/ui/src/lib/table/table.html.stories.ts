...
const Template: Story = (args) => ({
  ...
  /* template */
  template: `
    <div class="veera-table">
      <div class="veera-table__inner">
        <table class="veera-table__table">
          <tr class="veera-table__header-row">
            <th class="veera-table__header-cell">
              <div class="veera-table__header-cell-inner">Sündmusteenus</div>
            </th>
            <th class="veera-table__header-cell">
              <div class="veera-table__header-cell-inner">Staatus</div>
            </th>
            <th class="veera-table__header-cell">
              <div class="veera-table__header-cell-inner">Viimati muudetud</div>
            </th>
          </tr>
          <tr class="veera-table__body-row">
            <td class="veera-table__body-cell">
              <div class="veera-table__body-cell-inner">Abiellumine</div>
            </td>
            <td class="veera-table__body-cell">
              <div class="veera-table__body-cell-inner">Mustand</div>
            </td>
            <td class="veera-table__body-cell">
              <div class="veera-table__body-cell-inner">2021-07-15</div>
            </td>
            <td class="veera-table__body-cell">
              <div class="veera-table__body-cell-inner">
                <div class="veera-track veera-track--direction-horizontal veera-track--layout-flex" style="--gap:3;">
                  <button title="Edit">
                    <span class="veera-screenreader-text">Edit</span>
                  ...
                  <button title="Delete">
                    <span class="veera-screenreader-text">Delete</span>
                    <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" height="18px">
          ...
          <tr class="veera-table__body-row">
            ...
            <td class="veera-table__body-cell">
              <div class="veera-table__body-cell-inner">Avaldatud</div>
            </td>
            <td class="veera-table__body-cell">
              <div class="veera-table__body-cell-inner">2018-07-17</div>
            </td>
            <td class="veera-table__body-cell">
              <div class="veera-table__body-cell-inner">
                <div class="veera-track veera-track--direction-horizontal veera-track--layout-flex" style="--gap:3;">
                  <button title="Add">
                    <span class="veera-screenreader-text">Add</span>
          ...
          <tr class="veera-table__body-row">
            ...
            <td class="veera-table__body-cell">
              <div class="veera-table__body-cell-inner">Avaldamise ootel</div>
            </td>
            <td class="veera-table__body-cell">
              <div class="veera-table__body-cell-inner">2016-07-05</div>
            </td>
            <td class="veera-table__body-cell">
              <div class="veera-table__body-cell-inner">
                <div class="veera-track veera-track--direction-horizontal veera-track--layout-flex" style="--gap:3;">
