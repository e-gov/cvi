...
export class AppComponent {
  boxes: Box[] = [
    ...
    },
    {
      ...
      borderStyle: 'dotted',
      id: 5,
      link: 'https://example.com/purple',
      targets: [6], // purple box also points to cyan box
      label:
        'This <i>is</i> <b>purple</b>. This one has text that does not fit so the box automatically changed its size to be bigger.',
    },
    {
      x: 500,
      y: 100,
      ...
      label:
        'This <i>is</i> <b>cyan</b>. This one has more text but fixed width and height.',
      width: 150,
      height: 75,
    },
  ];
